...
SINGLE_OUTPUT_DIR="${OUTPUT_DIR_SINGLE:-/workspace/reports/tp_single_training_smoke}"
TP_OUTPUT_DIR="${OUTPUT_DIR_TP:-/workspace/reports/tp_multi_training_smoke}"
...
echo "  ${SINGLE_OUTPUT_DIR/#\/workspace/$ROOT}/report.json"
echo "  ${TP_OUTPUT_DIR/#\/workspace/$ROOT}/report.json"
